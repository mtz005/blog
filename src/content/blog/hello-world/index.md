...
| ------------ | ---------------------------------------------- | ------------------------------------------ |
| **Audience** | Developers, investors, technical readers       | Recruiters, collaborators, general network |
| **Tone**     | Raw, unfiltered, technical                     | Clean, story-driven, no edge               |
| **Length**   | Unlimited                                      | ~1,000–1,300 chars                         |
